export const CONFIG = {
  ...
  VAPI_ASSISTANT_ID: import.meta.env.VITE_VAPI_ASSISTANT_ID || '53b95554-46a3-40c6-aaf5-7d489598fd2f',
  API_BASE_URL: import.meta.env.VITE_API_BASE_URL || 'https://aarogyavaani-api.vercel.app',
